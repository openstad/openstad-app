...
module.exports = {
  ...
  OAUTH_MONGO_PORT: process.env.OAUTH_MONGO_PORT || process.env.MONGO_PORT || 27017,
  OAUTH_MONGO_USER: process.env.OAUTH_MONGO_USER || process.env.MONGO_USER || '',
  OAUTH_MONGO_PASSWORD: process.env.OAUTH_MONGO_PASSWORD || process.env.MONGO_PASSWORD || '',
  ...
  FRONTEND_MONGO_DB_HOST: process.env.FRONTEND_MONGO_DB_HOST || process.env.MONGO_HOST || 'localhost',
  FRONTEND_MONGO_DB_PORT: process.env.FRONTEND_MONGO_DB_PORT || process.env.MONGO_PORT || 27017,
  FRONTEND_MONGO_DB_USER: process.env.FRONTEND_MONGO_DB_USER || process.env.MONGO_USER || '',
  FRONTEND_MONGO_DB_PASSWORD: process.env.FRONTEND_MONGO_DB_PASSWORD || process.env.MONGO_PASSWORD || '',
  ...
  ADMIN_MONGO_DB_HOST: process.env.ADMIN_MONGO_DB_HOST || process.env.MONGO_HOST || 'localhost',
  ADMIN_MONGO_DB_PORT: process.env.ADMIN_MONGO_DB_PORT || process.env.MONGO_PORT || 27017,
  ADMIN_MONGO_USER: process.env.ADMIN_MONGO_USER || process.env.MONGO_USER || '',
  ADMIN_MONGO_PASSWORD: process.env.ADMIN_MONGO_PASSWORD || process.env.MONGO_PASSWORD || '',
